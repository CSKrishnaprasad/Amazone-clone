  ...
  return (
    <div className="login">
      ...
      <div className="login_container">
        ...
        <p>By signing in you agree the complete terms,please refer to the privacy policy and cookies and refer our interest based Ads Notice </p>
      <button  className='login_joinnow'>Join Now</button>
      </div>
    </div>
  );
}
